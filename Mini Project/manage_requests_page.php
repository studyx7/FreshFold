...
if(User::getUserType() !== 'staff' && User::getUserType() !== 'admin') {
...
<head>
    ...
    <title>Manage Requests - FreshFold</title>
...
<div class="sidebar">
    ...
    <nav class="nav flex-column">
        ...
        <a class="nav-link active" href="manage_requests_page.php">
            <i class="fas fa-tasks"></i> Manage Requests
        </a>
        <a class="nav-link" href="report_issue_page.php">
